<?php
/**
 * team9 functions and definitions
 *
...
if ( ! function_exists( 'team9_setup' ) ) :
	/**
	 ...
	 */
	function team9_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on team9, use a find and replace
		 * to change 'team9' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'team9', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'team9_custom_background_args', array(
...
add_action( 'wp_enqueue_scripts', 'team9_scripts' );
